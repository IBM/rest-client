...
public class SKLMRESTObjectsSymmetricKey extends SKLMRESTCommand 
{
   private static final Logger logger = LogManager.getLogger(SKLMRESTObjectsSymmetricKey.class.getName());

   private static String path   = "/SKLM/rest/v1/objects/symmetrickey";
   private String type          = "POST";
							   
   public SKLMRESTObjectsSymmetricKey(String theRESTURL, String arguments, String userAuthId)
   {
      logger.traceEntry();	  
