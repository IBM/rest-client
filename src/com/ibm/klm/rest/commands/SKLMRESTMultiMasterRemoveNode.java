...
*/
public class SKLMRESTMultiMasterRemoveNode extends SKLMRESTCommand
{
   private static final Logger logger = LogManager.getLogger(SKLMRESTMultiMasterRemoveNode.class.getName());

   private static String path   = "/SKLM/rest/v1/ckms/config/nodes/removeNode";
   private String type          = "POST";
				   
   public SKLMRESTMultiMasterRemoveNode(String theRESTURL, String arguments, String userAuthId)
   {
      logger.traceEntry();	  
