...
public class SKLMRESTObjectsKeypair extends SKLMRESTCommand
{
   private static final Logger logger = LogManager.getLogger(SKLMRESTObjectsKeypair.class.getName());

   private static String path   = "/SKLM/rest/v1/objects/keypair";
   private String type          = "POST";
							   
   public SKLMRESTObjectsKeypair(String theRESTURL, String arguments, String userAuthId)
   {
      logger.traceEntry();	  
   ...
   /*
   {
   	  ...
   	  "privateKeyCryptoUsageMask": "string",
   	  "algorithm": "string",
   	  "bitLength": "string",
   	  "privateKeyBlock": {
   ...
   */
   ...
   public String doBodyArgs()
   {
      ...
      String jsonInputStringInner1="\"privateKeyBlock\": {";
